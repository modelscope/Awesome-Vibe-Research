...
| Research Network | 面向 AI/agent 辅助科研的可验证研究资产协议与工具链：将 Git 工作区中的 paper、skill、workflow、code 与 evidence 打包为 Walrus release snapshot，注册到 Sui，并通过 live index、Web UI 与 CLI 解析回原始内容，适合科研产物复现、发布、归档和 agent skill 分发；项目仍在持续更新。 | protocol/CLI/web | [GitHub](https://github.com/Euraxluo/research-network) · [Demo](https://research-network-web.vercel.app) | [Use CLI](https://research-network-web.vercel.app/use-cli.html) |
