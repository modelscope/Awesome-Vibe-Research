...
| PaperPRISM | 面向 AI 研究者的 Codex 原生科研写作工作流，组织已有研究材料、构建论文论证链并核验主张与证据，支持 LaTeX 写作、模拟审稿和修订规划 | workflow | <!--stars:XueruiSu/Paper-PRISM-->⭐ updating<!--/stars--> | [GitHub](https://github.com/XueruiSu/Paper-PRISM) | - | - |
