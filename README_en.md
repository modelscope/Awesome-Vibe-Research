...
| BrainPilot | Open-source multi-agent research workspace spanning literature research, experiments, data analysis, coding, and writing, with self-hosting, cloud access, and Graph of Trace execution tracking | agent/app | <!--stars:NeuroAIHub/BrainPilot-->⭐ updating<!--/stars--> | [GitHub](https://github.com/NeuroAIHub/BrainPilot) | [Demo](https://brainpilot.chat) | [arXiv 2026](https://arxiv.org/abs/2607.15079) |
...
| arXiv Browser Research Skill | Codex/browser-use skill for polite arXiv browser fallback when OpenAlex, Semantic Scholar, or the arXiv API are rate limited or incomplete; extracts structured titles, authors, abstracts, arXiv IDs, and PDF links from arXiv result pages. | skill | <!--stars:pikaqiu2333/arxiv-browser-research-->⭐ updating<!--/stars--> | [GitHub](https://github.com/pikaqiu2333/arxiv-browser-research) | [Skill](https://github.com/pikaqiu2333/arxiv-browser-research/blob/main/SKILL.md) | - |
...
| Jev Social | Browser-grounded agent for social-media research: Jev selects bounded read-only search, detail, and comment operations for Instagram, TikTok, or LinkedIn; the local `socai CLI` executes them in the researcher's signed-in Chrome and retains source-linked evidence and reports. Researchers must still verify platform terms, data licenses, and ethics requirements | agent/tool | <!--stars:socai-io/jev-social-->⭐ updating<!--/stars--> | [GitHub](https://github.com/socai-io/jev-social) | [Recorded Instagram report](https://github.com/socai-io/jev-social/blob/c411ae1532dd37ab94f8164f13552ed05f4c9ecc/docs/example-report.md) | - |
