...
| PaperPRISM | Codex-native research writing workflow for AI researchers that organizes existing research assets, builds paper arguments, checks claims against evidence, and supports LaTeX writing, simulated peer review, and revision planning | workflow | <!--stars:XueruiSu/Paper-PRISM-->⭐ updating<!--/stars--> | [GitHub](https://github.com/XueruiSu/Paper-PRISM) | - | - |
