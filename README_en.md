...
| Multi-Source Search | Cross-platform Agent Skill for research retrieval and fact-checking that coordinates at least two search capabilities, prioritizes primary sources, detects derivative coverage, and reconciles conflicting evidence; it can produce a claim-to-source evidence ledger with confidence scores and an offline structural validator. | skill | <!--stars:sandbaseai/sandbase-skills-->⭐ updating<!--/stars--> | [GitHub](https://github.com/sandbaseai/sandbase-skills) | [Skill](https://github.com/sandbaseai/sandbase-skills/blob/main/research/multi-source-search/SKILL.md) | - |
